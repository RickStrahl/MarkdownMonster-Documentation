Markdown Monster supports rendering Mermaid Diagrams both as inline content in Markdown documents, or by using Mermaid files (`.mmd`) that are self-contained Mermaid documents.
