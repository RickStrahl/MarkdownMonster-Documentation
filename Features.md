...
* Keyboard and Command support for most operations
...
### AI Integration
* Context Sensitive Chat UI with embedding
* Image Generation
* Optional Text Completions (ctrl-space)
* Summarize Text
* Translation
* Grammar and Style checking
* Online and local OpenAi provider support
* Bring your own Key
...
* Full file operations in Folder Browser
